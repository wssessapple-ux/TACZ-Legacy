...
# 声明
本项目为社区非官方移植构建，与原作者以及官方 TaCZ 项目无关！

本模组基于 KasumiNova（TaCZ Team）开发的《永恒枪械工坊：零（TaCZ）》源码，针对 Minecraft 1.12.2‑Forge 版本进行的非官方移植构建。
原作者从未发布过针对 1.12.2 的正式构建版本。
wssessapple‑ux 仅负责该 1.12.2 版本的工程配置、环境适配、构建打包与发布工作，模组核心源代码由 KasumiNova 开发。

> ⚠️ 已知问题：部分瞄具、倍镜黑屏渲染问题源自上游原始代码，并非本次 1.12.2 移植构建新增引入。
